...
//             <button onClick={exportExcel} className="py-2 px-5 bg-gray-200 rounded hover:bg-primary hover:text-white">
//               Excel
//             </button>
//           </div>
//           <div>
...
//                   {/* <td className="p-2">
//                     {p.bill_image ? (
//                       <img src={`/uploads/${p.bill_image}`} alt="bill" className="w-10 h-10 object-cover rounded" />
//                     ) : "N/A"}
//                   </td> */}
//                 </tr>
//               ))}
