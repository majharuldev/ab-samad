  ...
  const printReport = () => {
    ...
    const totalRow = `
      <tr style="font-weight:bold;background:#f0f0f0">
        <td colspan="4" style="border:1px solid #ccc;padding:6px;text-align:right">${t("Total")}:</td>
    ...
    const html = `
      <table style="width:100%;border-collapse:collapse">
        <thead style="background:#11375B;color:white">
          <tr>
            <th style="border:1px solid #ccc;padding:6px">${t("SL.")}</th>
            <th style="border:1px solid #ccc;padding:6px">${t("Month")}</th>
            <th style="border:1px solid #ccc;padding:6px">${t("Driver")}</th>
            <th style="border:1px solid #ccc;padding:6px">${t("Mobile")}</th>
            <th style="border:1px solid #ccc;padding:6px">${t("Trips")}</th>
            <th style="border:1px solid #ccc;padding:6px">${t("Income")}</th>
            <th style="border:1px solid #ccc;padding:6px">${t("Expense")}</th>
            <th style="border:1px solid #ccc;padding:6px">${t("Profit")}</th>
          </tr>
        </thead>
        <tbody>
          ${bodyRows}
    ...
    <div className="md:p-2">
      <div className="p-4 max-w-7xl mx-auto bg-white shadow rounded-lg border border-gray-200">
        <h2 className="text-xl font-bold text-primary flex items-center gap-2">
          ...
          {t("Driver")} {t("Monthly")} {t("Performance Report")}
        </h2>
          ...
          <table id="driver-report" className="min-w-full text-sm text-left">
            <thead className="bg-gray-200 text-primary capitalize text-xs">
              <tr>
                ...
                <th className="px-2 py-3">{t("Month")}</th>
                <th className="px-2 py-3">{t("Driver")}</th>
                <th className="px-2 py-3">{t("Mobile")}</th>
                <th className="px-2 py-3">{t("Trips")}</th>
                <th className="px-2 py-3">{t("Income")}</th>
                <th className="px-2 py-3">{t("Expense")}</th>
                <th className="px-2 py-3">{t("Profit")}</th>
              </tr>
            </thead>
            <tbody>
            ...
            {currentDriverReport.length > 0 && (
              <tfoot className="bg-gray-100 font-bold">
                <tr>
                  <td colSpan="4" className="text-right px-4 py-3">{t("Total")}:</td>
