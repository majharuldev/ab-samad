                    ...
                    <table className="min-w-full text-sm text-left">
                        <thead className="bg-gray-200 text-primary">
                            <tr>
                                ...
                                <th className="p-2">{t("Cost")} {t("Category")}</th>
                                <th className="p-2">{t("Size")}</th>
                                <th className="p-2">{t("Start Point")}</th>
                                <th className="p-2">{t("End Point")}</th>
                                <th className="p-2">{t("Distance")}</th>
                                <th className="p-2">{t("KPL")}</th>
                                <th className="p-2">{t("Fuel Cost")}</th>
